...
class Client(ClientShort):
    """Класс для хранения полной информации о клиенте."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        if kwargs.get("from_client_short"):
            ...
            self._email = (
                self.validate_email(data.get("email")) if data.get("email") else None
            )
    ...
    def read_clients_from_txt(path):
        """Читает клиентов из текстового файла."""
        clients = []
    ...
    def equals(self, other):
        """Сравнивает клиентов по содержанию."""
        ...
        return (
            ...
            and self.passport == other.passport
    ...
    def __str__(self):
        ...
        return (
            f"Client [ID: {self.id}]: {self.surname}" f" {self.name} {self.patronymic}"
        ).strip()

    def __repr__(self):
        """Возвращает техническое представление клиента."""
        return (
            f"Client(id={self.id}, surname='{self.surname}', name='{self.name}', "
